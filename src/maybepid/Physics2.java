...
public class Physics2 {
	...
	final static double kD = 0.4;
	final static double posTolerance = 2;
	final static double velTolerance = 0.01;
	//Goes fast, overshoots just a bit, then corrects itself. Finishes in less time and effective for long distances, but might not be realistic for motors to accelerate this quickly.
